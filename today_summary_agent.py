...
You MUST ONLY use information present in the activity logs.

Do NOT invent activities.

Do NOT assume meetings, emails, workouts, podcasts,
phone calls, alarms, or any other activity unless
they explicitly appear in the logs.

Below is the user's activity from today:
